...
import createAuth0Client, {
  PopupLoginOptions, Auth0Client, RedirectLoginOptions, GetIdTokenClaimsOptions,
  GetTokenSilentlyOptions, GetTokenWithPopupOptions, LogoutOptions,
...
export class VueAuth extends Vue {
  ...
  async getUser() {
    const result: User | undefined = await this.auth0Client.getUser();
